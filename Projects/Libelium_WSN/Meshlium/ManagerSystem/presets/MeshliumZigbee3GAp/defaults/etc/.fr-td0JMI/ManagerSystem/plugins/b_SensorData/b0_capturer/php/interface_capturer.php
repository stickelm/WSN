...
function make_storedData()
{
    ...
    exec("ls /mnt/user/zigbee_data/", $files);
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td style="text-indent: 0px;"><input type="text" readonly  value="'.$DATABASE.'" /></td>
                        </tr>
                        <tr>
                            <td style="text-indent: 0px;"><span><b>Table: </b></span></td>
                            <td style="text-indent: 0px;"><input type="text" readonly  value="'.$TABLE.'" /></td>
                        </tr>
                        <tr>
                            <td style="text-indent: 0px;"><span><b>IP: </b></span></td>
                            <td style="text-indent: 0px;"><input type="text" readonly  value="'.$IP.'" /></td>
                        </tr>
                        <tr>
                            <td style="text-indent: 0px;"><span><b>Port: </b></span></td>
                            <td style="text-indent: 0px;"><input type="text" readonly  value="'.$PORT.'" /></td>
                        </tr>
                        <tr>
                            <td style="text-indent: 0px;"><span><b>User: </b></span></td>
                            <td style="text-indent: 0px;"><input type="text" readonly  value="'.$USER.'" /></td>
                        </tr>
                        <tr>
                            <td style="text-indent: 0px;"><span><b>Password: </b></span></td>
                            <td style="text-indent: 0px;"><input type="text" readonly  value="'.$PASS.'" /></td>
                        </tr>
                    </tbody>
                </table>';
    $list .= '</div>
...
function make_capturer_inputs()
{
    ...
    $list.='<div class="title2">Captured Data</div>';


$list.= "<div id='daemonStatus'>";
if (exec("ps ax | grep zigbeeStorer | grep -v grep | wc -l") == 1)
{
   $list.= '<div id="dRunning"></div> <span> <b>Daemon running</b></span>';
}
elseif (exec("ps ax | grep zigbeeStorer | grep -v grep | wc -l") == 0)
{
   $list.= '<div id="dStopped"></div> <span id="changeDaemonStatus" onclick="startZigbeeStorerDaemon(\''.$section.'\',\''.$plugin.'\')"> <b>Start daemon</b></span>';
}
else
{
...
$list.= "</div>";
    ...
    $list.='<div id="tab4content" style="display: none;">';
        ...
        $list .= '<button id="showMeNowStart" onclick="continousStoped = 0;showMeNow(\''.$section.'\',\''.$plugin.'\');" >Start Scan</button>
                  <button id="showMeNowStop" onclick="stopMeNow(\''.$section.'\',\''.$plugin.'\');" style="display: none;" >Stop Scan</button>
                  <input value="10" id="intervalForNow" maxlength="10" style="width: 60px;" name="intervalForNow" type="text"><span>Scan interval</span>
                    <br><br>';
