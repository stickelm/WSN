...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshApGw/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshApGw/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshApGw/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshApGw/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshApGw/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumMeshApGw/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default



## 4) Archivo de variables globales
    sudo echo "Meshlium Mesh AP GW" > /mnt/lib/cfg/currentPreset
