...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeGprsAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeGprsAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeGprsAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeGprsAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeGprsAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumZigbeeGprsAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default
...
## 4) Archivo de variables globales
    sudo echo "Meshlium Zigbee GPRS AP" > /mnt/lib/cfg/currentPreset
