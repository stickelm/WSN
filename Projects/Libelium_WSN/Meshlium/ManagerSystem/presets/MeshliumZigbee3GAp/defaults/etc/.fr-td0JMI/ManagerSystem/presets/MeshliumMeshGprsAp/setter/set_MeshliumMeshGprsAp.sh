...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshGprsAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshGprsAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshGprsAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshGprsAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshGprsAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumMeshGprsAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default



## 4) Archivo de variables globales
    sudo echo "Meshlium Mesh GPRS AP" > /mnt/lib/cfg/currentPreset
