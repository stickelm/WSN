...
elseif ($_POST['type']=="startGpsDaemon")
{
    ...
    exec("sudo /etc/init.d/GpsScanD.sh start &> /dev/null &");
      ...
      if ($nfilas > 0)
      {
          echo '<table style="width: 550px;">
                        ...
                        <tr>
                            ...
                            <th style="text-align:left;">Satellites</th>
         ...
         for ($i=0; $i<$nfilas; $i++)
         {
            ...
            echo '
                    <tr>
                        ...
                        <td style="text-align:left;text-indent:0px;">'.$resultado['date'].'</td>
                        <td style="text-align:left;text-indent:0px;">'.$resultado['longitude'].'</td>
                        <td style="text-align:left;text-indent:0px;">'.$resultado['latitude'].'</td>
                        <td style="text-align:left;text-indent:0px;">'.$resultado['altitude'].'</td>
                        <td style="text-align:left;text-indent:0px;">'.$resultado['satellites'].'</td>
                        <td style="text-align:left;text-indent:0px;">'.$resultado['speed'].'</td>
                    </tr>
                 ';
         }
