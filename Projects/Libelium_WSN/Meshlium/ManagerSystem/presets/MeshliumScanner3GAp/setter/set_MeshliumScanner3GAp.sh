...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScanner3GAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScanner3GAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScanner3GAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScanner3GAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScanner3GAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumScanner3GAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default



## 4) Archivo de variables globales
    sudo echo "Meshlium Scanner 3G AP" > /mnt/lib/cfg/currentPreset
