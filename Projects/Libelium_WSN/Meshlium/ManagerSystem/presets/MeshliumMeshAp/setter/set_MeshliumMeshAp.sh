...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumMeshAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumMeshAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default



## 4) Archivo de variables globales
    sudo echo "Meshlium Mesh AP" > /mnt/lib/cfg/currentPreset
