...
// plugins/section_name/plugin_name/css/plugin1.css
$_plugin_css=Array("basic.css","styles.css");
...
// plugins/section_name/plugin_name/javascript/plugin1.js
$_plugin_javascript=Array("main.js","jquery-1.9.1.min.js","jquery.json-1.3.min.js","ajax.js","json_encode.js","form_fields_check.js","scripts.js");
...
// Is better to use $html variable to avoid direct call of the plugin from browsers.
    ...
    exec("rm /var/www/ManagerSystem/tmp/*");

    if(!strstr($initConf['0'], "zigbee"))
    {
        $html= '<b>The "Zigbee" module is not instaled</b></div>';
    }
    else
    {
        include $base_plugin.'php/map.php';
    }
