...
/* ------------------------------------------------------------------------ */
{
    ...
    $list ='
    <div class="title2">Users Manager</div>
   ...
   // $list .= make_user_form_panel ();
    ...
    /*
      DESCOMENTAR PARA QUE APAREZCA LA OPCIÓN DE CAMBIAR USER Y PASS MYSQL

    $list .='
    <div class="title2">Mysql Password Manager</div>
    <div class="plugin_content">
        <button onclick="$(\'#mysqlPasswInputs\').show();">Change password</button>
        <div id="mysqlPasswInputs" style="display:none;"><br>
         <form id="mysql_form" name="mysql_form">
             <table><tbody>
                <tr>
                    <td>Password:</td>
                    <td><input type="password" class="ms_mandatory" name="mysqlPassword" id="mysqlPassword"  maxlength="30" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td><div id="mysqlPassword_ms_cte"></div></td>
                </tr>
                <tr>
                    <td>Confirm password:</td>
                    <td><input type="password" class="ms_mandatory" name="cnf_mysqlPassword" id="cnf_mysqlPassword"  maxlength="30" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td><div id="cnf_mysqlPassword_ms_cte"></div></td>
                </tr>
             </tbody></table>
         </form>
         <button onclick="changeMysqlPass(\''.$section.'\', \''.$plugin.'\', \'mysql_form\');">Save</button>
         <button onclick="$(\'#mysqlPasswInputs\').hide();">Cancel</button>
        </div>
    </div>';
*/
    return $list;
   ...
   $list = '
    ...
    <div class="nl">
     ...
     <table>
      ...
      <tr>
        <td>Password:</td>
        <td><input type="password" class="ms_mandatory" name="password" id="password"  maxlength="10" /></td>
      </tr>
      <tr>
          <td></td>
      ...
      <tr>
        <td>Confirm password:</td>
        <td><input type="password" class="ms_mandatory" name="cnf_password" id="cnf_password"  maxlength="10" /></td>
      </tr>
      <tr>
          <td></td>
