...
$operators_file_path=$base_plugin.'data/operators.txt';
    ...
    {
        $html= '<b>The "3G" radio is not instaled</b>';
    }
    elseif(($currentPreset['0'] == "Meshlium 3G AP") || ($currentPreset['0'] == "Meshlium Mesh 3G AP") ||
 ($currentPreset['0'] == "Meshlium Zigbee 3G AP") || ($currentPreset['0'] == "Meshlium Zigbee Mesh 3G AP") ||
 ($currentPreset['0'] == "Meshlium Scanner 3G AP"))
    {
        $html=addInputGprs();
    }
    else
    {
        $html= '<b>Please go to presets and select some 3G preset</b>';
    }
