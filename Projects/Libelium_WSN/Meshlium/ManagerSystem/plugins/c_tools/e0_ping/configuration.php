...
$plugin_name="Ping"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Octavio Bened&iacute;"; //THIS SHOULD BE A LINE.
$plugin_description="Allows to do ping to addresses through a choosen interface"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/ping.png"; // BY DEFAULT
$plugin_icon_selected="images/ping_hv.png"; // BY DEFAULT
?>