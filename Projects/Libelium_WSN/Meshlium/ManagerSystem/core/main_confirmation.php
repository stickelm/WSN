...
include_once 'core/structure/confirmation/header.php';
echo $html_title;
flush();
unset ($html_title);
...
// Top logo and menu
include_once 'core/structure/confirmation/top_menu.php';
echo $core_top_menu;
flush();
unset ($core_top_menu);


include_once 'core/structure/confirmation/confirmation.php';
//////////////////
// FOOTER
//////////////////

// Send to the client the footer.
include_once 'core/structure/confirmation/footer.php';
echo $html;
flush();
unset ($html);
