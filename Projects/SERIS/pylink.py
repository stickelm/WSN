...
while True:
    ...
    if(m):
        ...
        emoncms_upload(battery,temperature,solar,time_stamp)
        ...
        if upload_counter == 3:
            ...
            try:
                ...
                print "Yeelink Httplib Badstatus"+time_stamp
                continue
            except (httplib.HTTPException, socket.error) as ex:
            # In case the domain is not reacheable, API server is down
                print "Yeelink socket error"+time_stamp
                continue
            ...
            try:
                ...
                print "Yeelink Value Error"+time_stamp+"\n", Argument
                pass
            upload_counter += 1
