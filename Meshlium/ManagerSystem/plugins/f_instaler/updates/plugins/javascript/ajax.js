...
function installPlugin(section,plugin,libplg)
{
    submit_data="section="+section+"&plugin="+plugin+"&libplg="+libplg+"&type=installPlugin";
    ...
    $.ajax({
        ...
        success: function(datos){
            ...
            $("#resultsOfLoad").html("");
            checkForPlugins(section,plugin);
            fadenotify();
        }
    });
}
...
function installSection(section,plugin,linke)
{
    submit_data="section="+section+"&plugin="+plugin+"&link="+linke+"&type=installSection";
    notify("loadinfo.net.gif", "Loading...");
    $.ajax({
        type: "POST",
        url: "index.php",
...
function checkForPlugins(section,plugin)
{
    submit_data="section="+section+"&plugin="+plugin+"&type=checkForPlugins";
    notify("loadinfo.net.gif", "Loading...");
    $.ajax({
        type: "POST",
        url: "index.php",
