...
$(function() {
    $('#topesri').click(function(){
        if ($('#todoTh').css('display') == "none")
         $('#topesri').css("background-image", "url('plugins/c_cloudPlatforms/c0_m2mApp/images/topmenos.png')"); 
        else
         $('#topesri').css("background-image", "url('plugins/c_cloudPlatforms/c0_m2mApp/images/topmas.png')"); 
        $('#todoTh').slideToggle();
    });
    $('#topaxeda').click(function(){
        if ($('#todoAx').css('display') == "none")
         $('#topaxeda').css("background-image", "url('plugins/c_cloudPlatforms/c0_m2mApp/b0_machineCloud/images/topmenos.png')"); 
        else
         $('#topaxeda').css("background-image", "url('plugins/c_cloudPlatforms/c0_m2mApp/b0_machineCloud/images/topmas.png')"); 
