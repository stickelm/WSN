...
if ($_POST['type']=="start")
{
    exec("sudo /etc/init.d/xGate.sh start &");
    echo "ok";
}
else if ($_POST['type']=="stop")
{
    exec("sudo /etc/init.d/xGate.sh stop");
    echo "ok";
}
...
else if ($_POST['type']=="startTW")
{
    exec("/etc/init.d/tw_microServerd start");
    echo "ok";
}
else if ($_POST['type']=="stopTW")
{
    exec("/etc/init.d/tw_microServerd stop");
    echo "ok";
}
?>