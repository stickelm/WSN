...
$plugin_name="Beep"; // THIS SHOULD BE A LINE.
$plugin_version="0.1"; // THIS SUOULD BE A LINE.
$plugin_author="Ernesto Sanhez"; //THIS SHOULD BE A LINE.
$plugin_description="Beep"; // THIS SHOULD BE A SMALL DESCRIPTION
...
$plugin_icon="images/beep.png"; // BY DEFAULT
$plugin_icon_selected="images/beep_hv.png"; // BY DEFAULT
?>
