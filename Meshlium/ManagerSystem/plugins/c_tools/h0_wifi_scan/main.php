...
// plugins/section_name/plugin_name/javascript/plugin1.js
$_plugin_javascript=Array("jquery-1.3.2.min.js","jquery.json-1.3.min.js","ajax.js","json_encode.js", "scripts.js","form_fields_check.js");
...
include_once $API_core.'../msh_init_conf.php';
   ...
   */
    ...
    if(!strstr($initConf['0'], "wifiscan"))
    {
        $html= '<b>The "Wifi scan" module is not instaled</b>';
    }
    else
    {
        $html=make_interface();
