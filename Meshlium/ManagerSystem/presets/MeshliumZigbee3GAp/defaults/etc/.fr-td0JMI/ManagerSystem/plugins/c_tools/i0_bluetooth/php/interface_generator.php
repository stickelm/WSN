                ...
                <table style="float: left;">
                    <tbody>
                        <tr>
                            ...
                            <td><div id="name_ms_cte" class="ms_cte"></div></td>
                        </tr>
                        <tr>
                            <td>
...
{
   $list.= '<div id="dStopped"></div> <span id="changeDaemonStatus" onclick="startBtDaemon(\''.$section.'\',\''.$plugin.'\')"> <b>Start daemon</b></span>';
}
else
{
...
function make_interface()
{
    ...
    $list.='<div class="title2">Bluetooth</div>';
