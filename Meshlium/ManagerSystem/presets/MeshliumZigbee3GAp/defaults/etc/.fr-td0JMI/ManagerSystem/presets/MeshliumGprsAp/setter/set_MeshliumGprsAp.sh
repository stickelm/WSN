...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumGprsAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumGprsAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumGprsAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumGprsAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumGprsAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumGprsAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default
...
## 4) Archivo de variables globales
    sudo echo "Meshlium GPRS AP" > /mnt/lib/cfg/currentPreset
