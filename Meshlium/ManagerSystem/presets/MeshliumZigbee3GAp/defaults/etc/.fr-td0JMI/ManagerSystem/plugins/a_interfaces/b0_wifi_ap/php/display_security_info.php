...
/* ------------------------------------------------------------------------ */
{
    ...
    if(file_exists($base_plugin."data/wep_pass"))
    {
        exec("cat ".$base_plugin."data/wep_pass", $ret);
        if(strlen(trim($ret['1'])) == 5)
        {
...
/* ------------------------------------------------------------------------ */
{
    ...
    <div id="wpa">
      <div class="pl hidden">
        <input type="checkbox" name="wpa_psk_ckb" id="wpa_psk_ckb"   checked  readonly />
        <span style="font-size: 12px;">WPA Personal (PSK)</span>
      </div>
      <div id="wpa_psk" class="nl">
      <table>
      <tbody>
      <tr>
       <td>Password:</td>
    ...
    if(file_exists($base_plugin."data/wpa_pass")) {
        exec("cat ".$base_plugin."data/wpa_pass", $ret);
        $list .= ' value="'.$ret['1'].'" ';
    }
