...
function make_mac_filter($interface,$selected)
{
    ...
    <form id="mac_filter_'.$interface.'" onsubmit="return false;" >
        <div class="">
            ...
            $result.=' onchange="check_conditions();"  >
            <legend>Mac Filter</legend>
            <div id="mac_filter_hide_'.$interface.'">
                <table cellpadding="0" cellspacing="5">
                    <tbody>
                        <tr>
                            <td>Mac list type</td>
                            <td>
                                <select name="mac_list_type_'.$interface.'" id="mac_list_type_'.$interface.'">';
                        ...
                        <tr>
                            <td>
                                <select name="mac_list_'.$interface.'" id="mac_list_'.$interface.'">';
                                    if (!empty($ini))
                                    {
                                        foreach ($ini as $line)
                                        {
                            ...
                            <td>
                                <input type="button" id="int_save_but_'.$interface.'" style="cursor: pointer;" value="Delete" onclick="complex_ajax_call(\'mac_filter_'.$interface.'\',\'output\',\''.$section.'\',\''.$plugin.'\',\'del_mac\',\''.$interface.'\');" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="button" name="mac_filter_add_but_'.$interface.'" value="Add MAC" onclick="show_mac()"/>
                            </td>
                            <td>
                                <input type=\"text\" name="mac_filter_add_'.$interface.'" id="mac_filter_add_'.$interface.'" maxlength="17">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                            ...
                            <td>
                                <div id="mac_filter_add_'.$interface.'_ms_cte"></div>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                            <td>
                                <input type="button" id="add_mac_filter_ok" value="Ok" onclick="add_mac(\''.$plugin.'\', \''.$section.'\');"/>
                            </td>
                        </tr>
                    </tbody>
                </table>
