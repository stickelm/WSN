...
This web application is optimized to get the most of the <a href="http://www.libelium.com/products/meshlium">Meshlium</a> router.<br />
The code is released under the terms of the <a href="http://www.gnu.org/licenses/gpl-2.0.html#SEC1">GPL2 License</a>.
        </div>
        <div class="title2">Version</div>
        <div class="plugin_content">
Meshlium Manager System v.'.$manager_system_version.'<br>
Serial number: '.exec("cat /mnt/lib/.info/serialNumber").'
        </div>
        <div class="title2">Documentation and resources</div>
        <div class="plugin_content">
<a href="http://www.libelium.com/support/meshlium">Documentation</a>
<br />
