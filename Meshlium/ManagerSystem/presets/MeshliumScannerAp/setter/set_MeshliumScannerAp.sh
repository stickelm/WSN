...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScannerAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScannerAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScannerAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScannerAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumScannerAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumScannerAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default



## 4) Archivo de variables globales
    sudo echo "Meshlium Scanner AP" > /mnt/lib/cfg/currentPreset
