...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumZigbeeMeshAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default



## 4) Archivo de variables globales
    sudo echo "Meshlium Zigbee Mesh AP" > /mnt/lib/cfg/currentPreset
