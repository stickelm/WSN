...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumZigbeeAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default
...
## 4) Archivo de variables globales
    sudo echo "Meshlium Zigbee AP" > /mnt/lib/cfg/currentPreset
