...
$_main_title='Meshlium Manager System 3.0';
...
{
    if ($section == "c_cloudPlatforms")
    {
        unset ($html);
        include_once 'plugins/c_cloudPlatforms/defaultCloud.php';
        echo $html;
        flush();
        unset ($html);
    }
    else
    {
        ...
        echo '<div id="not_selected_plugin">
            <table cellspacing=10><tbody><tr>
                ...
                <td style="color: white;">Click on a plugin to load</td>
            </tr></tbody></table></div>';
    }
}
