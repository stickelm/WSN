...
$core_top_menu.=$prst['0'].'
    ...
    <div id="presets">
        <form name="f_presets" action="#" method="get">
            <input type="submit" name="presets" id="s_presets" value="Presets" style="border: 0px; background: transparent; color: white; font-weight: bold; cursor: pointer;margin-top:-2px"  \>
        </form>
    </div>
';
?>
