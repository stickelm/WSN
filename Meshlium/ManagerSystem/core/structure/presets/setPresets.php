...
switch ($_POST['set']) {
    ...
    case 'meshlium_3G_ap':
        ...
        echo "<h2>Meshlium has been configured as Meshlium 3G AP</h2>";
        //showChangesPresets($ret);
        break;
    ...
    case 'meshlium_mesh_ap_3G_gw':
        ...
        echo "<h2>Meshlium has been configured as Meshlium Mesh AP 3G GW</h2>";
        //showChangesPresets($ret);
        break;
    ...
    case 'meshlium_zb_3G_ap':
        $return = exec('sh /var/www/ManagerSystem/presets/MeshliumZigbee3GAp/setter/set_MeshliumZigbee3GAp.sh', $ret);
        echo "<h2>Meshlium has been configured as Meshlium Zigbee 3G AP</h2>";
        //showChangesPresets($ret);
        break;
    ...
    case 'meshlium_zb_mesh_ap_3G_gw':
        $return = exec('sh /var/www/ManagerSystem/presets/MeshliumZigbeeMesh3GAp/setter/set_MeshliumZigbeeMesh3GAp.sh', $ret);
        echo "<h2>Meshlium has been configured as Meshlium Zigbee Mesh AP 3G GW</h2>";
        //showChangesPresets($ret);
        break;


    case 'meshlium_scanner_ap':
        $return = exec('sh /var/www/ManagerSystem/presets/MeshliumScannerAp/setter/set_MeshliumScannerAp.sh', $ret);
        echo "<h2>Meshlium has been configured as Meshlium Scanner AP</h2>";
        //showChangesPresets($ret);
        break;
    case 'meshlium_scanner_3G_ap':
        $return = exec('sh /var/www/ManagerSystem/presets/MeshliumScanner3GAp/setter/set_MeshliumScanner3GAp.sh', $ret);
        echo "<h2>Meshlium has been configured as Meshlium Scanner 3G AP</h2>";
        //showChangesPresets($ret);
        break;
    case 'meshlium_scanner_zigbee_ap':
        $return = exec('sh /var/www/ManagerSystem/presets/MeshliumScannerZigbeeAp/setter/set_MeshliumScannerZigbeeAp.sh', $ret);
        echo "<h2>Meshlium has been configured as Meshlium Scanner Zigbee AP</h2>";
        //showChangesPresets($ret);
        break;
