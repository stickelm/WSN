...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshApGw/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshApGw/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshApGw/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshApGw/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshApGw/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumZigbeeMeshApGw/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default



## 4) Archivo de variables globales
    sudo echo "Meshlium Zigbee Mesh AP GW" > /mnt/lib/cfg/currentPreset
