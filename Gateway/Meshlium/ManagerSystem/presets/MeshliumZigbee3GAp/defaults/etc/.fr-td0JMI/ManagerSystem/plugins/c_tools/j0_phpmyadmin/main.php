...
<a href="http://'.$_SERVER['SERVER_ADDR'].'/phpmyadmin" target="_blank" style="float: right;">Open in a new Window</a><br><br>
<div style="width: 100%; height: 620px; overflow: auto;">
<iframe src ="http://'.$_SERVER['SERVER_ADDR'].'/phpmyadmin" style="width: 1080px; height: 100%; border: 1px solid #454545;">
