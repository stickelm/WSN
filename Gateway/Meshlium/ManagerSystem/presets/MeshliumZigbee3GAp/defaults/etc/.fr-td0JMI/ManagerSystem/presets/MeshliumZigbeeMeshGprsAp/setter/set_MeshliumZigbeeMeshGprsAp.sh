...
## 1) Sustituimos archivos del sistema:
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshGprsAp/defaults/etc /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshGprsAp/defaults/bin /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshGprsAp/defaults/mnt /
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshGprsAp/defaults/root /
...
## 3) Poner Direcciones NAT
    ...
    sudo cp -r /var/www/ManagerSystem/presets/MeshliumZigbeeMeshGprsAp/plugins /var/www/ManagerSystem/
    sudo cp /var/www/ManagerSystem/presets/MeshliumZigbeeMeshGprsAp/confirmation/default /var/www/ManagerSystem/core/structure/confirmation/data/default



## 4) Archivo de variables globales
    sudo echo "Meshlium Zigbee Mesh GPRS AP" > /mnt/lib/cfg/currentPreset
