...
$operators_file_path=$base_plugin.'data/operators.txt';
    ...
    {
        $html= '<b>The "GPRS" radio is not instaled</b>';
    }
    elseif(($currentPreset['0'] == "Meshlium GPRS AP") || ($currentPreset['0'] == "Meshlium Mesh GPRS AP") || ($currentPreset['0'] == "Meshlium Zigbee GPRS AP") || ($currentPreset['0'] == "Meshlium Zigbee Mesh GPRS AP"))
    {
        $html=addInputGprs();
    }
    else
    {
        $html= '<b>Please go to presets and select some GPRS preset</b>';
    }
